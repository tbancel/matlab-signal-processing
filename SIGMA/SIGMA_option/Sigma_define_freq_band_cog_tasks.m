function [freq_bands, bands_list, filter_order]=Sigma_define_freq_band_cog_tasks()


%% 0- The frquency bounds (minimal and maximal)
fmin=0.5; % The minimum frequency for the EEG data
fmax=45; % The maximum frequency f the EEG data
