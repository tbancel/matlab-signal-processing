...
%==========================================================================
% This script compute the mean cross corelation between two data
o_synchro_time_cross_corr_ch=[];
temp0=[];
if (Nepochs==1)
o_synchro_time_cross_corr_epo=[];
if Nsubj==1 
o_synchro_time_cross_corr=[];
end
end
...
o_synchro_time_cross_corr=[o_synchro_time_cross_corr o_synchro_time_cross_corr_epo];
