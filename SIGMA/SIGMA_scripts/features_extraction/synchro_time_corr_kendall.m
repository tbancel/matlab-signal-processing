...
%==========================================================================
% This script compute the correlation type Kendall
o_synchro_time_corr_kendall_ch=[];
temp0=[];
if (Nepochs==1)
o_synchro_time_corr_kendall_epo=[];
if Nsubj==1 
o_synchro_time_corr_kendall=[];
end
end
...
o_synchro_time_corr_kendall=[o_synchro_time_corr_kendall o_synchro_time_corr_kendall_epo];
