%==========================================================================
%% This script is part of the BCI toolbox, it's used by the main function to compute the "kurtosis value "Energie" "
%==========================================================================
% This script compute theKurtosis for each channels and epoches
o_kurtosis_ch=[];temp0=[];
%o_fractal_epo=[];
if (Nepochs==1)
o_kurtosis_epo=[];
...
o_time_kurtosis=[o_time_kurtosis o_kurtosis_epo];
