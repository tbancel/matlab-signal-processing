function features_results=Time_enveloppe_mean(init_parameter,features_results,s_EEG,Nsubj,Nepochs,Nmethode)
...
if Nsubj==1
features_results.o_time_enveloppe_mean=[];
end
end
...
features_results.o_time_enveloppe_mean=[features_results.o_time_enveloppe_mean o_time_enveloppe_mean_epo];
