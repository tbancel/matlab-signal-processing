...
if Nsubj==1
features_results.o_time_mean_amplitude_bo=[];
end
end
...
features_results.o_time_mean_amplitude_bo=[features_results.o_time_mean_amplitude_bo o_time_mean_amplitude_bo_epo];
