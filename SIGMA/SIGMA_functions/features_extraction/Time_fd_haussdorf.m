function features_results=Time_fd_haussdorf(init_parameter,~,features_results,s_EEG,Nsubj,Nepochs,Nmethode)
...
if Nsubj==1
features_results.o_time_fractal_haussdorf=[];
end
end
...
features_results.o_time_fractal_haussdorf=[features_results.o_time_fractal_haussdorf o_time_fractal_haussdorf_epo];
