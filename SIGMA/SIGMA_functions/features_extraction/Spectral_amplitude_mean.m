...
o_spect_time_mean_ch=[];
temp0=[];

if (Nepochs==1)
o_spect_time_mean_epo=[];
if Nsubj==1
features_results.o_spect_time_mean=[];
end
end
...
o_spect_time_mean_value0 = mean(abs(spect(fdata)));       
o_spect_time_mean_ch =[o_spect_time_mean_ch,o_spect_time_mean_value0];
...
o_spect_time_mean_value0 = mean(abs(spect(i_EEG)));
o_spect_time_mean_ch =[o_spect_time_mean_ch,o_spect_time_mean_value0];
% Track the identification of the band
if ((Nsubj==1)&&(Nepochs==1))
...
clear o_spect_time_mean_value0
end
o_spect_time_mean_epo=o_spect_time_mean_ch';  
features_results.o_spect_time_mean=[features_results.o_spect_time_mean o_spect_time_mean_epo];

%features_results.o_spect_time_mean=o_spect_time_mean;


if ((Nsubj==1)&&(Nepochs==1))
features_results.o_spect_time_mean_band=temp0;
end    
%%
% % %----------------------------------------------------------------------
