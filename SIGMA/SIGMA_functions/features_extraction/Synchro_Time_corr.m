function features_results=Synchro_amplitude_corr(init_parameter,~,features_results,s_EEG,Nsubj,Nepochs,Nmethode)
...
if Nsubj==1 
features_results.o_synchro_time_corr=[];
end
end
...
features_results.o_synchro_time_corr=[features_results.o_synchro_time_corr o_synchro_time_corr_epo];
