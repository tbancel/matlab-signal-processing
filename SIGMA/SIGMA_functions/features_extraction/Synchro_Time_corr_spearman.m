function features_results=Synchro_amplitude_corr_spearman(init_parameter,~,features_results,s_EEG,Nsubj,Nepochs,Nmethode)
...
if Nsubj==1 
features_results.o_synchro_time_corr_spearman=[];
end
end
...
features_results.o_synchro_time_corr_spearman=[features_results.o_synchro_time_corr_spearman o_synchro_time_corr_spearman_epo];
