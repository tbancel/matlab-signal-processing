function features_results=Synchro_amplitude_cross_corr(init_parameter,~,features_results,s_EEG,Nsubj,Nepochs,Nmethode)
...
o_synchro_time_cross_corr_ch=[];
temp0=[];
if (Nepochs==1)
o_synchro_time_cross_corr_epo=[];
if Nsubj==1 
features_results.o_synchro_time_cross_corr=[];
end
end
...
r=xcorr(fdata_1,fdata_2,'coeff');                                        
o_synchro_time_cross_corr0=mean(r);
o_synchro_time_cross_corr_ch=[o_synchro_time_cross_corr_ch; o_synchro_time_cross_corr0];
...
o_synchro_time_cross_corr_epo=o_synchro_time_cross_corr_ch;  

features_results.o_synchro_time_cross_corr=[features_results.o_synchro_time_cross_corr o_synchro_time_cross_corr_epo];

%features_results.o_synchro_time_cross_corr=o_synchro_time_cross_corr;

features_results.channels_combinaison=channels_combinaison;
if ((Nsubj==1)&&(Nepochs==1))
features_results.o_synchro_time_cross_corr_band=temp0;
end    
