function Sigma_compute_ERP_visualization( init_parameter_eegfc,start_sample,end_sample)
%==========================================================================
...
%==========================================================================
%%The input is a copy of init_parameter in wich all the necessary
...
Sigma_visualisating_ERP(EEG,start_sample,end_sample);
